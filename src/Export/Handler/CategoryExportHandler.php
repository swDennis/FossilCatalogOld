...
class CategoryExportHandler extends AbstractHandler
{
    ...
    {
        $toExport = $this->tagRepository->getTagColumnCount(TagRepositoryInterface::GET_ONLY_CATEGORIES);
    ...
    public function export(): ExportStatus
    {
        ...
        $data = $this->tagRepository->getExportList(self::EXPORT_LIMIT, $status->getExported(), TagRepositoryInterface::GET_ONLY_CATEGORIES);
