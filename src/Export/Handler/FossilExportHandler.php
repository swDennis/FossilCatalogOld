...
class FossilExportHandler extends AbstractHandler
{
    ...
    {
        $toExport = $this->fossilRepository->getFossilListColumnCount([]);
    ...
    public function export(): ExportStatus
    {
        ...
        $data = $this->fossilRepository->getExportList(self::EXPORT_LIMIT, $status->getExported());
